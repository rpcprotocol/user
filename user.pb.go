...
type RegisterResponse struct {
	...
	Code    int32  `protobuf:"varint,1,opt,name=code,proto3" json:"code,omitempty"`      // 响应码，0表示成功，其它表示失败
...
type GetUserInfoResponse struct {
	...
	Code    int32  `protobuf:"varint,1,opt,name=code,proto3" json:"code,omitempty"`      // 响应码，0表示成功，其它表示失败
	Message string `protobuf:"bytes,2,opt,name=message,proto3" json:"message,omitempty"` // 响应消息
	User    *User  `protobuf:"bytes,3,opt,name=user,proto3" json:"user,omitempty"`       // 查询到的用户信息
}
...
var file_user_proto_rawDesc = []byte{
	...
	0x69, 0x6e, 0x67, 0x22, 0x5f, 0x0a, 0x0f, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x52,
	...
	0x01, 0x28, 0x03, 0x52, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x22, 0x63, 0x0a, 0x13, 0x47,
	...
	0x22, 0x62, 0x0a, 0x04, 0x55, 0x73, 0x65, 0x72, 0x12, 0x16, 0x0a, 0x06, 0x75, 0x73, 0x65, 0x72,
	...
	0x03, 0x61, 0x67, 0x65, 0x32, 0xf7, 0x01, 0x0a, 0x07, 0x47, 0x72, 0x65, 0x65, 0x74, 0x65, 0x72,
	0x12, 0x35, 0x0a, 0x08, 0x53, 0x61, 0x79, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x12, 0x12, 0x2e, 0x75,
	0x73, 0x65, 0x72, 0x2e, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	0x1a, 0x13, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x52, 0x65, 0x73,
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x44, 0x0a, 0x0b, 0x47, 0x65, 0x74, 0x55,
	...
	0x49, 0x6e, 0x66, 0x6f, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x1d,
	0x5a, 0x1b, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x72, 0x70, 0x63,
...
var file_user_proto_depIdxs = []int32{
	8, // 0: user.GetUserInfoResponse.user:type_name -> user.User
	0, // 1: user.Greeter.SayHello:input_type -> user.HelloRequest
	2, // 2: user.Greeter.Register:input_type -> user.RegisterRequest
	4, // 3: user.Greeter.Login:input_type -> user.LoginRequest
	6, // 4: user.Greeter.GetUserInfo:input_type -> user.GetUserInfoRequest
	1, // 5: user.Greeter.SayHello:output_type -> user.HelloResponse
	3, // 6: user.Greeter.Register:output_type -> user.RegisterResponse
	5, // 7: user.Greeter.Login:output_type -> user.LoginResponse
	7, // 8: user.Greeter.GetUserInfo:output_type -> user.GetUserInfoResponse
